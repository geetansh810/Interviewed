<div align="center">
  <br />
      <img src="https://github.com/geetansh810/Interviewed/blob/main/public/fullLogo.jpeg" alt="Project Banner">
  <br />
  ...
  <h3 align="center">Interviewed: A job interview preparation platform powered by AI Voice agents</h3>
</div>
...
Built with Next.js for the user interface and backend logic, Firebase for authentication and data storage, styled with TailwindCSS and using Vapi's voice agents, Interviewed is a website project designed to help you learn integrating AI models with your apps. The platform offers a sleek and modern experience for job interview preparation.
...
```bash
git clone https://github.com/geetansh810/interviewed.git
cd interviewed
```
